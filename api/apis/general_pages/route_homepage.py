...
# This HTTP GET API URI calls the asynchronous function "home" which returns a list of country names stored in the variable "countries" as well as the html page "homepage.html" 
# (the homepage) to which the variable (countries) is passed."
...
# This HTTP GET API URI calls the asynchronous function "enquiries" the html page "enquiries.html" 
...
# This HTTP GET API URI calls the asynchronous function "homelist" which returns a list of country names stored in the variable "countries" as well as the html page "homepage.html" 
# (the homepage) to which the variable (countries) is passed, it also returns a list of countries as the variable "länder" which match the user's selected preferences based on filter selections on the homepage 
# and the user's origin country. The list of countries returned is generated by the oracle_picks() function as defined in the Empfehler class in empfehler.py"
...
# This HTTP GET API URI calls the asynchronous function "homelist2" which returns a list of country names stored in the variable "countries" as well as the html page "user_dashboard.html" 
# (the dashboard accessible to logged in users) to which the variable (countries) is passed, it also returns a list of countries as the variable "länder" which match the user's selected 
# preferences based on filter selections on the user's dashboard, the user's origin country. The list of countries returned is generated by the oracle_picks() function as defined in 
# the Empfehler class in empfehler.py. The user's username is also used by the get_saved_trips() function as defined in the User_man class in user_management.py to fetch and return 
